...
YOUR_BOT_TOKEN = "8054353237:AAFYfqRso0aN8dFYmNP2o_RWLF9fKwKXYZ0" # <--- This line needs to be changed

# ==================== New Addition: Multiple Admin IDs ====================
# Add your and other admins' Telegram User IDs to the list below
ADMIN_CHAT_IDS = ["6190125375"] # Example: ["YOUR_ADMIN_USER_ID_1", "YOUR_ADMIN_USER_ID_2"]
# =================================================================
